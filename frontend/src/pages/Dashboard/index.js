...
const useStyles = makeStyles((theme) => ({
  ...
  card0: {
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#228c8f", // Conexões ativas
    color: "#eee",
    borderRadius: "12px",
    boxShadow: "0 4px 10px rgba(0, 0, 0, 0.2)", // Sombra padrão
    transition: "transform 0.3s ease, box-shadow 0.3s ease", // Transição suave
    "&:hover": {
      transform: "translateY(-5px)", // Levanta o card
      boxShadow: "0 8px 20px rgba(0, 0, 0, 0.3)", // Aumenta a sombra
    },
  },
  card00: {
    padding: theme.spacing(3),
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#228c8f ", //empresas
    color: "#eee",
    borderRadius: "12px",
    boxShadow: "0 4px 10px rgba(0, 0, 0, 0.2)", // Sombra padrão
    transition: "transform 0.3s ease, box-shadow 0.3s ease", // Transição suave
  ...
  card1: {
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#228c8f ", //conversas
    color: "#eee",
    borderRadius: "12px",
    boxShadow: "0 4px 10px rgba(0, 0, 0, 0.2)", // Sombra padrão
    transition: "transform 0.3s ease, box-shadow 0.3s ease", // Transição suave
  ...
  card2: {
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#228c8f ", //aguardando
    color: "#eee",
    borderRadius: "12px",
    boxShadow: "0 4px 10px rgba(0, 0, 0, 0.2)", // Sombra padrão
    transition: "transform 0.3s ease, box-shadow 0.3s ease", // Transição suave
  ...
  card3: {
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#228c8f ", //finalizados
    color: "#eee",
    borderRadius: "12px",
    boxShadow: "0 4px 10px rgba(0, 0, 0, 0.2)", // Sombra padrão
    transition: "transform 0.3s ease, box-shadow 0.3s ease", // Transição suave
  ...
  card4: {
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#228c8f ", //novos contatos
    color: "#eee",
    borderRadius: "12px",
    boxShadow: "0 4px 10px rgba(0, 0, 0, 0.2)", // Sombra padrão
    transition: "transform 0.3s ease, box-shadow 0.3s ease", // Transição suave
  ...
  card8: {
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#228c8f ", //tempo media de conversa
    color: "#eee",
    borderRadius: "12px",
    boxShadow: "0 4px 10px rgba(0, 0, 0, 0.2)", // Sombra padrão
    transition: "transform 0.3s ease, box-shadow 0.3s ease", // Transição suave
  ...
  card9: {
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#228c8f ", //tempo de espera #cc991b
    color: "#eee",
    borderRadius: "12px",
    boxShadow: "0 4px 10px rgba(0, 0, 0, 0.2)", // Sombra padrão
    transition: "transform 0.3s ease, box-shadow 0.3s ease", // Transição suave
                ...
                <Grid container spacing={3}>
                  <Grid item xs={8}>
                    <Typography component="h3" variant="h6" paragraph>
                      {i18n.t("dashboard.title.connectionsactive")}
                    </Typography>
                    <Grid item>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                <Grid container spacing={3}>
                  <Grid item xs={8}>
                    <Typography component="h3" variant="h6" paragraph>
                      {i18n.t("dashboard.title.companies")}
                    </Typography>
                    <Grid item>
                      <Typography component="h1" variant="h4">
