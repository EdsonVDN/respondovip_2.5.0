...
const drawerWidth = 270; //ALTERA O TAMANHO DA ABA LATERAL
...
const useStyles = makeStyles((theme) => ({
  root: {
    ...
    "& .MuiButton-outlinedPrimary": {
      ...
      backgroundColor: theme.mode === "light" ? "#228c8f" : "#1c1c1c",
      //border: theme.mode === 'light' ? '1px solid rgba(0 124 102)' : '1px solid rgba(255, 255, 255, 0.5)',
    },
    "& .MuiTab-textColorPrimary.Mui-selected": {
      color: theme.mode === "light" ? "#228c8f" : "#FFFFFF",
    },
  },
  avatar: {
    width: "100%",
    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar variant="dense" className={classes.toolbar}>
          ...
          <Typography
            fontFamily="'Arimo', sans-serif" // Use a fonte Gingham
            fontWeight="300" // Peso bold
            component="h2"
            variant="h6"
            color="inherit"
            noWrap
          ...
          <IconButton
            ...
            color="inherit"
          >
            <CachedIcon style={{ color: "white", fontSize: "25px" }} />
          </IconButton>
